...
def bump_patch_version(version):
    ...
    e.g. 0.9.1.snapshot.20181105150718
    Args:
...
class SnapshotCommand(Command):
    ...
    def finalize_options(self):
        ...
        new_version = "{}.SNAPSHOT.{}".format(self.old_version, date)
    ...
    def run(self):
        ...
        #     publish_to_nexus()
        # except:
        #     print("{} publishing to nexus Failed...".format(self.project_name))
        update_version_file(self.version_file, self.old_version)
        #os.system('rm -vrf ./build ./dist ./*.pyc ./*.tgz ./*.egg-info')
        os.system('rm -vrf ./build ./*.pyc ./*.tgz ./*.egg-info ./*/__pycache__ __pycache__') # 要執行佈署, 所以./dist 佈署完後才刪
